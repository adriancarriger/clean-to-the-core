...
export class FirebaseCacheService {
  ...
  cache: FirebaseCache = {};
  /**
   * Creates the {@link FirebaseCacheService}
   * 
  ...
  /**
   * - Sets up a {@link FirebaseCache} item that provides Firebase data
   ...
   * - When Firebase sends a value this {@link FirebaseCache} item is set to loaded, 
